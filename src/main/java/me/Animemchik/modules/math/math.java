package me.Animemchik.modules.math;
...
public final class math implements Module {
    ...
    private static Value abs(Value... args) {
        ...
        return NumberValue.of(Math.abs(args[0].asInteger()));
    }
    ...
    private static Value max(Value... args) {
        ...
        return NumberValue.of(Math.max(args[0].asInteger(), args[1].asInteger()));
    }
    ...
    private static Value min(Value... args) {
        ...
        return NumberValue.of(Math.min(args[0].asInteger(), args[1].asInteger()));
    }
